...
class ReportEvaluator:
    ...
    def evaluate(self, report_text: str, stock_symbol: str = "") -> Dict:
        ...
        recommendations = self._generate_recommendations(
            structure_score, data_score, sophistication_score, actionability_score, sentiment_score, report_text
        )
        ...
        return {
            ...
            "metrics": {
                ...
                "basic": {"word_count": len(report_text.split()), "character_count": len(report_text)},
            },
    ...
    def _evaluate_structure(self, text: str) -> Tuple[float, Dict]:
        ...
        score = (sections_coverage * 0.6 + min(headers / 10, 1) * 0.2 + min(paragraphs / 15, 1) * 0.2) * 100
    ...
    def _evaluate_actionability(self, text: str) -> Tuple[float, Dict]:
        ...
        time_horizons = re.findall(
            r"\d+[-\s](?:day|week|month|year)|short[- ]term|medium[- ]term|long[- ]term", text, re.IGNORECASE
        )
